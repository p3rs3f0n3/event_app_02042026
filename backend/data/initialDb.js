const INITIAL_DB = {
  ...
  users: [
    { id: 1, username: 'admin', password: 'Admin.EventApp.2026', fullName: 'Administrador Base', phone: '3005550101', whatsappPhone: '3005550101', email: 'admin@eventapp.local', role: 'ADMIN', termsAccepted: false, termsAcceptedAt: null },
    { id: 2, username: 'ejecutivo.ana', password: 'Funcional.EventApp.2026', fullName: 'Ana Torres', phone: '3005550202', whatsappPhone: '3005550202', email: 'ana.torres@eventapp.local', role: 'EJECUTIVO', termsAccepted: false, termsAcceptedAt: null },
    { id: 3, username: 'ejecutivo.bruno', password: 'Funcional.EventApp.2026', fullName: 'Bruno Diaz', phone: '3005550203', whatsappPhone: '3005550203', email: 'bruno.diaz@eventapp.local', role: 'EJECUTIVO', termsAccepted: false, termsAcceptedAt: null },
    { id: 4, username: 'coord', password: 'Funcional.EventApp.2026', fullName: 'Lucia Mendez', phone: '3005550303', whatsappPhone: '3005550303', email: 'lucia.mendez@eventapp.local', role: 'COORDINADOR', termsAccepted: false, termsAcceptedAt: null },
    { id: 5, username: 'cliente', password: 'Funcional.EventApp.2026', fullName: 'Laura Gómez', phone: '3005550404', whatsappPhone: '3005550404', email: 'cliente.base@eventapp.local', role: 'CLIENTE', termsAccepted: false, termsAcceptedAt: null },
    { id: 6, username: 'cliente.alpina', password: 'Funcional.EventApp.2026', fullName: 'Mariana Vélez', phone: '3005550405', whatsappPhone: '3005550405', email: 'alpina.qa@eventapp.local', role: 'CLIENTE', termsAccepted: false, termsAcceptedAt: null },
    { id: 7, username: 'cliente.colcafe', password: 'Funcional.EventApp.2026', fullName: 'Santiago Ruiz', phone: '3005550406', whatsappPhone: '3005550406', email: 'colcafe.qa@eventapp.local', role: 'CLIENTE', termsAccepted: false, termsAcceptedAt: null },
    { id: 8, username: 'cliente.nutresa', password: 'Funcional.EventApp.2026', fullName: 'Valentina Pérez', phone: '3005550407', whatsappPhone: '3005550407', email: 'nutresa.qa@eventapp.local', role: 'CLIENTE', termsAccepted: false, termsAcceptedAt: null },
  ],
  executives: [
